...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMAPAGO_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORMAPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORMAPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORMAPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORMAPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORMAPAGO actions', async () => {
      const expectedActions = [
        {
