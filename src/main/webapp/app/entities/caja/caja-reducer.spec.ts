...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './caja.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAJA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAJA actions', async () => {
      const expectedActions = [
        {
