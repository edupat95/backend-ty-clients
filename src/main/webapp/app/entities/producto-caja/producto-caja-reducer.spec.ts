...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOCAJA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOCAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOCAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOCAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOCAJA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOCAJA actions', async () => {
      const expectedActions = [
        {
