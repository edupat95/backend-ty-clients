...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './documento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCUMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTO actions', async () => {
      const expectedActions = [
        {
