...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOPRODUCTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOPRODUCTO actions', async () => {
      const expectedActions = [
        {
