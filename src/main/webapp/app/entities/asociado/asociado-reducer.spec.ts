...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './asociado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASOCIADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASOCIADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASOCIADO actions', async () => {
      const expectedActions = [
        {
