...
export const PlanDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fidelizacion2App.plan.delete.question">
        <Translate contentKey="fidelizacion2App.plan.delete.question" interpolate={{ id: planEntity.id }}>
