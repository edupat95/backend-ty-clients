...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOMESA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOMESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOMESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOMESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOMESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOMESA actions', async () => {
      const expectedActions = [
        {
