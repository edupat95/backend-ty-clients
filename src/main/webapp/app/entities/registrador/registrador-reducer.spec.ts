...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGISTRADOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGISTRADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGISTRADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGISTRADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGISTRADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGISTRADOR actions', async () => {
      const expectedActions = [
        {
