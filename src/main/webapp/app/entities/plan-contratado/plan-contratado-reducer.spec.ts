...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANCONTRATADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANCONTRATADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANCONTRATADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANCONTRATADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANCONTRATADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANCONTRATADO actions', async () => {
      const expectedActions = [
        {
