...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASOCIADOCLUB_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASOCIADOCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASOCIADOCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASOCIADOCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASOCIADOCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASOCIADOCLUB actions', async () => {
      const expectedActions = [
        {
