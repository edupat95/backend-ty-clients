...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './acceso.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCESO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCESO actions', async () => {
      const expectedActions = [
        {
