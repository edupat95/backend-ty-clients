...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mesa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESA_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESA actions', async () => {
      const expectedActions = [
        {
