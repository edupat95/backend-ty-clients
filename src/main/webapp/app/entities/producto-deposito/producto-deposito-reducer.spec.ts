...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './producto-deposito.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTODEPOSITO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTODEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTODEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTODEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTODEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTODEPOSITO actions', async () => {
      const expectedActions = [
        {
