...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTREGADOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTREGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTREGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTREGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTREGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTREGADOR actions', async () => {
      const expectedActions = [
        {
