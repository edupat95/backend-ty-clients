...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRABAJADOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRABAJADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRABAJADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRABAJADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRABAJADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRABAJADOR actions', async () => {
      const expectedActions = [
        {
