...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOVENTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOVENTA actions', async () => {
      const expectedActions = [
        {
