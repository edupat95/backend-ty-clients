...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './deposito.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPOSITO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPOSITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPOSITO actions', async () => {
      const expectedActions = [
        {
