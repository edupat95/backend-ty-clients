...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINCLUB_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADMINCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINCLUB actions', async () => {
      const expectedActions = [
        {
