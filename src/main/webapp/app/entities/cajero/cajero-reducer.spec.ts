...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cajero.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAJERO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAJERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAJERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAJERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAJERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAJERO actions', async () => {
      const expectedActions = [
        {
